 ...
 */
@Component
public class CompanySearchValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return CompanySearchConditionRequest.class.isAssignableFrom(clazz);
    }
    ...
    public void validate(Object request, Errors errors) {
    	CompanySearchConditionRequest company = (CompanySearchConditionRequest)request;
